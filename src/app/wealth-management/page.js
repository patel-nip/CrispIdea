...
export default function WealthManagementPage() {
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] text-[#031333] font-sans selection:bg-[#a8c940]/20 selection:text-[#031333]">
      ...
      <header className="sticky top-0 z-50 bg-[#F8FAFC]/90 backdrop-blur-md border-b border-[#a8c940]/10 px-6 lg:px-12 py-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8 text-sm font-medium">
            ...
            <a href="/wealth-management" className="flex items-center gap-1.5 text-[#a8c940] font-semibold transition">
              <span className="inline-block w-1.5 h-1.5 rounded-full bg-[#a8c940]"></span>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col items-start text-left">
            <div className="flex items-center gap-2 mb-6">
              <div className="bg-[#031333] text-[#F8FAFC] w-6 h-6 rounded-lg flex items-center justify-center font-bold font-serif text-sm">
                C
              </div>
              <span className="bg-[#031333]/5 border border-[#a8c940]/15 rounded-full px-3 py-0.5 text-xs font-semibold text-[#031333]/80 uppercase tracking-wider block">
                Wealth Management
              </span>
            </div>
            ...
            <h1 className="text-4xl md:text-6xl font-serif font-black tracking-tight text-[#031333] leading-[1.08] mb-6">
              You're doing well.<br />But is your wealth<br />smartly <span className="text-[#a8c940]">working</span> for<br />your family's future?
            </h1>
            ...
            <div className="flex flex-wrap items-center gap-4 mb-10">
              <button 
                ...
                className="bg-[#031333] text-[#F8FAFC] text-xs font-semibold py-3.5 px-6 rounded-full hover:bg-black transition duration-200 flex items-center gap-2 cursor-pointer font-sans"
              >
                Book a discovery call <ArrowUpRight className="w-4 h-4" />
              </button>
              <a 
                href="#pricing"
                className="bg-white border border-[#a8c940]/20 text-[#031333] text-xs font-semibold py-3.5 px-6 rounded-full hover:bg-[#F8FAFC] transition duration-200 "
              >
                See pricing plans
              </a>
            </div>

            <div className="flex items-center gap-6 text-[10px] font-bold text-[#031333]/50 tracking-wider">
              <span>SEBI-registered RIA &bull; INA000019619</span>
              <span className="w-1.5 h-1.5 rounded-full bg-[#a8c940]/30"></span>
          ...
          <div className="lg:col-span-5 flex flex-col gap-4 w-full max-w-[500px] mx-auto">
            <div className="grid grid-cols-2 gap-4">
              {/* Card 1 */}
              <div className="bg-white border border-[#a8c940]/10 rounded-2xl p-4 ">
                <div className="bg-slate-100 w-8 h-8 rounded-lg flex items-center justify-center mb-3 text-[#031333]/60">
                  <Briefcase className="w-4 h-4" />
                </div>
                <h4 className="font-bold text-xs text-[#031333] mb-1">Professionally successful</h4>
                <p className="text-[10px] text-[#031333]/60 leading-relaxed font-semibold">Earning well, leading teams, navigating demanding careers.</p>
              </div>
              {/* Card 2 */}
              <div className="bg-white border border-[#a8c940]/10 rounded-2xl p-4 ">
                <div className="bg-slate-100 w-8 h-8 rounded-lg flex items-center justify-center mb-3 text-[#031333]/60">
                ...
                <h4 className="font-bold text-xs text-[#031333] mb-1">Ambitious family goals</h4>
                <p className="text-[10px] text-[#031333]/60 leading-relaxed font-semibold">International education, a bigger home, early retirement.</p>
              </div>
              {/* Card 3 */}
              <div className="bg-white border border-[#a8c940]/10 rounded-2xl p-4 ">
                <div className="bg-slate-100 w-8 h-8 rounded-lg flex items-center justify-center mb-3 text-[#031333]/60">
                ...
                <h4 className="font-bold text-xs text-[#031333] mb-1">Time constrained</h4>
                <p className="text-[10px] text-[#031333]/60 leading-relaxed font-semibold">Demanding careers leave little time for deep financial management.</p>
              </div>
              {/* Card 4 */}
              <div className="bg-white border border-[#a8c940]/10 rounded-2xl p-4 ">
                <div className="bg-slate-100 w-8 h-8 rounded-lg flex items-center justify-center mb-3 text-[#031333]/60">
                ...
                <h4 className="font-bold text-xs text-[#031333] mb-1">Accumulating wealth</h4>
                <p className="text-[10px] text-[#031333]/60 leading-relaxed font-semibold">Yet unsure if it's optimised for growth and security.</p>
              </div>
            </div>

            {/* Dark green Highlight Quote */}
            <div className="bg-[#001a00] text-white rounded-2xl p-5 flex gap-4 items-start border border-emerald-900/30">
              <Quote className="w-6 h-6 text-[#a8c940] shrink-0 transform rotate-180" />
      ...
      {/* VALUE BULLET BANNER */}
      <section className="py-4.5 bg-white border-b border-[#a8c940]/10 px-6">
        <div className="max-w-7xl mx-auto flex flex-wrap justify-between items-center gap-4 text-[10px] font-bold text-[#031333]/70 uppercase tracking-wider">
          <span className="flex items-center gap-1.5"><span className="w-1.5 h-1.5 rounded-full bg-[#a8c940]"></span> SEBI-aligned advisory</span>
          <span className="flex items-center gap-1.5"><span className="w-1.5 h-1.5 rounded-full bg-[#a8c940]"></span> 1800+ clients · 18 countries</span>
          <span className="flex items-center gap-1.5"><span className="w-1.5 h-1.5 rounded-full bg-[#a8c940]"></span> Backed by deep-tech research</span>
          <span className="flex items-center gap-1.5"><span className="w-1.5 h-1.5 rounded-full bg-[#a8c940]"></span> Fiduciary, fee-only options</span>
          <span className="flex items-center gap-1.5"><span className="w-1.5 h-1.5 rounded-full bg-[#a8c940]"></span> Audited performance</span>
        </div>
      </section>
      ...
      <section className="py-20 px-6 lg:px-12 bg-[#F8FAFC] border-b border-[#a8c940]/10">
        <div className="max-w-7xl mx-auto">
          <div className="mb-16">
            ...
            <p className="text-xs md:text-sm text-[#031333]/70 mt-3 max-w-2xl leading-relaxed">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {/* Target 1 */}
            <div className="bg-white border border-[#a8c940]/10 rounded-2xl p-6 flex flex-col justify-between h-48 border-t-3 border-t-[#a8c940]">
              <div className="bg-slate-50 w-9 h-9 rounded-lg flex items-center justify-center text-[#a8c940]/70 mb-4">
                <Sparkles className="w-4.5 h-4.5" />
              </div>
              <div>
                <h3 className="font-serif font-bold text-[#031333] text-sm mb-1.5">HNIs & family offices</h3>
                <p className="text-[11px] text-[#031333]/70 leading-relaxed font-semibold">
            ...
            <div className="bg-white border border-[#a8c940]/10 rounded-2xl p-6 flex flex-col justify-between h-48 border-t-3 border-t-[#a8c940]">
              ...
              <div>
                <h3 className="font-serif font-bold text-[#031333] text-sm mb-1.5">Ambitious professionals</h3>
                <p className="text-[11px] text-[#031333]/70 leading-relaxed font-semibold">
            ...
            <div className="bg-white border border-[#a8c940]/10 rounded-2xl p-6 flex flex-col justify-between h-48 border-t-3 border-t-[#a8c940]">
              ...
              <div>
                <h3 className="font-serif font-bold text-[#031333] text-sm mb-1.5">Founders & promoters</h3>
                <p className="text-[11px] text-[#031333]/70 leading-relaxed font-semibold">
            ...
            <div className="bg-white border border-[#a8c940]/10 rounded-2xl p-6 flex flex-col justify-between h-48 border-t-3 border-t-[#a8c940]">
              ...
              <div>
                <h3 className="font-serif font-bold text-[#031333] text-sm mb-1.5">NRIs & global Indians</h3>
                <p className="text-[11px] text-[#031333]/70 leading-relaxed font-semibold">
      ...
      <section className="py-20 px-6 lg:px-12 bg-white border-b border-[#a8c940]/10">
        <div className="max-w-7xl mx-auto">
          <div className="mb-16">
            <span className="text-xs font-bold text-[#a8c940] uppercase tracking-wider block mb-2">
              WHY CRISPIDEA WEALTH
            ...
            <p className="text-xs md:text-sm text-[#031333]/70 mt-3 max-w-xl leading-relaxed">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 items-stretch mb-8">
            {whyCards.map((card, idx) => (
              <div 
                key={idx} 
                className="bg-[#F8FAFC]/50 border border-[#a8c940]/10 rounded-2xl p-6 flex flex-col justify-between h-44 hover:border-[#a8c940]/30 transition"
              >
                <span className="text-xs font-bold text-[#a8c940]/40 block font-mono">{card.num}</span>
                <div>
                  <h4 className="font-serif font-bold text-sm text-[#031333] mb-1.5">{card.title}</h4>
                  <p className="text-[11px] text-[#031333]/65 leading-relaxed font-semibold">{card.desc}</p>
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="bg-[#001a00] text-[#F8FAFC] border border-emerald-950/20 rounded-3xl p-8 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            <div className="lg:col-span-8">
              <span className="text-[9px] font-bold text-[#a8c940] uppercase tracking-widest block mb-2.5 font-mono">
                05 &bull; THE PROOF
              </span>
              <h3 className="text-xl md:text-2xl font-serif font-bold mb-3 leading-snug">
                Fiduciary, transparent, accountable.
              </h3>
              <p className="text-xs text-[#F8FAFC]/70 max-w-2xl leading-relaxed font-medium">
            ...
            <div className="lg:col-span-4 flex gap-6 lg:justify-end">
              <div className="bg-emerald-950/40 border border-[#a8c940]/25 rounded-2xl p-4.5 min-w-[130px] text-center">
                <span className="text-2xl font-serif font-bold text-white block">21%+</span>
                <span className="text-[8px] uppercase tracking-wider font-bold text-[#a8c940] block mt-1">ALPHA TARGET 2026</span>
              </div>
              <div className="bg-emerald-950/40 border border-[#a8c940]/25 rounded-2xl p-4.5 min-w-[130px] text-center">
                <span className="text-2xl font-serif font-bold text-white block">$10 Tn</span>
                <span className="text-[8px] uppercase tracking-wider font-bold text-[#a8c940] block mt-1">COVERAGE MARKET CAP</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 px-6 lg:px-12 bg-white border-b border-[#a8c940]/10">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-stretch">
            ...
            {/* Phase 1 */}
            <div className="bg-[#F8FAFC]/50 border border-[#a8c940]/10 rounded-2xl p-6 flex flex-col justify-between gap-6">
              <div className="flex items-center justify-between border-b border-[#a8c940]/10 pb-4">
                <div className="flex items-center gap-3">
                  <div className="bg-white border border-[#a8c940]/15 w-8 h-8 rounded-lg flex items-center justify-center text-[#a8c940]/70">
                    <Compass className="w-4 h-4" />
                  </div>
                  <div>
                    <span className="text-[8px] font-bold text-[#a8c940] uppercase tracking-widest block">PHASE 1</span>
                    <h4 className="font-serif font-bold text-sm text-[#031333]">Discovery</h4>
                  </div>
                </div>
              </div>
              <div className="space-y-3 flex-1 flex flex-col justify-center">
                <div className="bg-white border border-[#a8c940]/5 rounded-xl p-4 flex gap-4">
                  <span className="text-xs font-mono font-bold text-[#a8c940]/40">01</span>
                  <div>
                    <h5 className="font-bold text-xs text-[#031333] mb-0.5">Goal mapping</h5>
                    <p className="text-[10px] text-[#031333]/60 font-semibold leading-relaxed">Retirement, education, lifestyle, liquidity events.</p>
                  </div>
                </div>
                <div className="bg-white border border-[#a8c940]/5 rounded-xl p-4 flex gap-4">
                  <span className="text-xs font-mono font-bold text-[#a8c940]/40">02</span>
                  <div>
                    <h5 className="font-bold text-xs text-[#031333] mb-0.5">Risk profile</h5>
                    <p className="text-[10px] text-[#031333]/60 font-semibold leading-relaxed">Quantified risk capacity and behaviour.</p>
                  </div>
                </div>
                <div className="bg-white border border-[#a8c940]/5 rounded-xl p-4 flex gap-4">
                  <span className="text-xs font-mono font-bold text-[#a8c940]/40">03</span>
                  <div>
                    <h5 className="font-bold text-xs text-[#031333] mb-0.5">Current snapshot</h5>
                    <p className="text-[10px] text-[#031333]/60 font-semibold leading-relaxed">Existing assets, liabilities, cash flow.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-[#F8FAFC]/50 border border-[#a8c940]/10 rounded-2xl p-6 flex flex-col justify-between gap-6">
              <div className="flex items-center justify-between border-b border-[#a8c940]/10 pb-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <span className="text-[8px] font-bold text-[#a8c940] uppercase tracking-widest block">PHASE 2</span>
                    <h4 className="font-serif font-bold text-sm text-[#031333]">Planning &amp; onboarding</h4>
                  </div>
                </div>
              </div>
              <div className="space-y-3 flex-1 flex flex-col justify-center">
                <div className="bg-white border border-[#a8c940]/5 rounded-xl p-4 flex gap-4">
                  <span className="text-xs font-mono font-bold text-[#a8c940]/40">04</span>
                  <div>
                    <h5 className="font-bold text-xs text-[#031333] mb-0.5">Asset allocation</h5>
                    <p className="text-[10px] text-[#031333]/60 font-semibold leading-relaxed">Across geographies, asset classes, lifecycles.</p>
                  </div>
                </div>
                <div className="bg-white border border-[#a8c940]/5 rounded-xl p-4 flex gap-4">
                  <span className="text-xs font-mono font-bold text-[#a8c940]/40">05</span>
                  <div>
                    <h5 className="font-bold text-xs text-[#031333] mb-0.5">Portfolio build</h5>
                    <p className="text-[10px] text-[#031333]/60 font-semibold leading-relaxed">Direct funds, equities, ETFs, debt, structured.</p>
                  </div>
                </div>
                <div className="bg-white border border-[#a8c940]/5 rounded-xl p-4 flex gap-4">
                  <span className="text-xs font-mono font-bold text-[#a8c940]/40">06</span>
                  <div>
                    <h5 className="font-bold text-xs text-[#031333] mb-0.5">Onboarding</h5>
                    <p className="text-[10px] text-[#031333]/60 font-semibold leading-relaxed">Paperwork, app setup, advisor introduction.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-[#F8FAFC]/50 border border-[#a8c940]/10 rounded-2xl p-6 flex flex-col justify-between gap-6">
              <div className="flex items-center justify-between border-b border-[#a8c940]/10 pb-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <span className="text-[8px] font-bold text-[#a8c940] uppercase tracking-widest block">PHASE 3</span>
                    <h4 className="font-serif font-bold text-sm text-[#031333]">Execution &amp; review</h4>
                  </div>
                </div>
              </div>
              <div className="space-y-3 flex-1 flex flex-col justify-center">
                <div className="bg-white border border-[#a8c940]/5 rounded-xl p-4 flex gap-4">
                  <span className="text-xs font-mono font-bold text-[#a8c940]/40">07</span>
                  <div>
                    <h5 className="font-bold text-xs text-[#031333] mb-0.5">Active execution</h5>
                    <p className="text-[10px] text-[#031333]/60 font-semibold leading-relaxed">SIPs, lump-sum, rebalancing, tax efficiency.</p>
                  </div>
                </div>
                <div className="bg-white border border-[#a8c940]/5 rounded-xl p-4 flex gap-4">
                  <span className="text-xs font-mono font-bold text-[#a8c940]/40">08</span>
                  <div>
                    <h5 className="font-bold text-xs text-[#031333] mb-0.5">Monthly review</h5>
                    <p className="text-[10px] text-[#031333]/60 font-semibold leading-relaxed">Market and portfolio health, risk parameters.</p>
                  </div>
                </div>
                <div className="bg-white border border-[#a8c940]/5 rounded-xl p-4 flex gap-4">
                  <span className="text-xs font-mono font-bold text-[#a8c940]/40">09</span>
                  <div>
                    <h5 className="font-bold text-xs text-[#031333] mb-0.5">Annual reset</h5>
                    <p className="text-[10px] text-[#031333]/60 font-semibold leading-relaxed">Goal review, allocation refresh, new opportunities.</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {services.map((svc, idx) => (
              <div 
                key={idx}
                className="bg-white border border-[#a8c940]/10 rounded-2xl p-6 flex flex-col items-start gap-4 hover:border-[#a8c940]/30 transition"
              >
                <div className="bg-[#F8FAFC] border border-[#a8c940]/10 w-10 h-10 rounded-xl flex items-center justify-center">
                  {svc.icon}
                </div>
                <div>
                  <h4 className="font-serif font-bold text-base text-[#031333] mb-1">{svc.title}</h4>
                  <p className="text-xs text-[#031333]/65 leading-relaxed font-semibold">{svc.desc}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="py-20 px-6 lg:px-12 bg-white border-b border-[#a8c940]/10">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-16">
            ...
            <a 
              href="/insights" 
              className="text-xs font-bold text-[#a8c940] hover:text-[#031333] transition flex items-center gap-1.5 cursor-pointer pb-2"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {letters.map((letter, idx) => (
              <div 
                key={idx}
                className="bg-[#F8FAFC]/40 border border-[#a8c940]/10 rounded-2xl p-6 flex flex-col justify-between h-48 hover:border-[#a8c940]/30 transition group"
              >
                <div>
                  <span className="text-[9px] font-bold text-[#a8c940] uppercase tracking-wider block mb-3 font-mono">{letter.quarter}</span>
                  <h4 className="font-serif font-bold text-base text-[#031333] mb-2 leading-snug group-hover:text-[#a8c940] transition">
                    {letter.title}
                  </h4>
                  <p className="text-xs text-[#031333]/60 font-semibold leading-relaxed">
                    {letter.desc}
                  </p>
                </div>
                ...
                <a 
                  href="/insights" 
                  className="text-xs font-bold text-[#0077bd] hover:text-[#0077bd] flex items-center gap-1 mt-4 pt-4 border-t border-[#a8c940]/5"
                >
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {testimonials.map((t, idx) => (
              <div 
                key={idx}
                className="bg-white border border-[#a8c940]/10 rounded-3xl overflow-hidden flex flex-col justify-between hover:transition duration-300"
              >
                {/* Play Button Video block placeholder */}
                <div className="h-44 bg-[#001a00] flex items-center justify-center relative border-b border-[#a8c940]/10 group cursor-pointer">
                ...
                <div className="p-6 flex-1 flex flex-col justify-between min-h-[160px]">
                  <div className="mb-6">
                    <Quote className="w-5 h-5 text-[#a8c940]/40 mb-3 transform rotate-180" />
                    <p className="font-serif italic text-sm text-[#031333] leading-relaxed font-semibold">
                      "{t.quote}"
                    </p>
                  </div>
                  <div>
                    <h4 className="font-sans font-bold text-xs text-[#031333]">{t.name}</h4>
                    <span className="text-[10px] text-[#031333]/50 font-bold block mt-0.5">{t.role}</span>
                  </div>
                </div>
              </div>
            ))}
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {team.map((member, idx) => (
              <div 
                key={idx}
                className="bg-[#F8FAFC]/40 border border-[#a8c940]/10 rounded-3xl overflow-hidden p-6 flex flex-col items-stretch gap-5 hover:border-[#a8c940]/30 transition"
              >
                {/* Advisor Image placeholder */}
                <div className="h-48 bg-[#001a00] rounded-2xl flex items-center justify-center border border-[#a8c940]/15 text-[#a8c940]/50">
                  <User className="w-14 h-14" />
                </div>
                <div>
                  <h4 className="font-serif font-bold text-base text-[#031333]">{member.name}</h4>
                  <span className="text-[10px] text-[#a8c940] font-bold uppercase tracking-wider block mt-1">{member.role}</span>
                  <p className="text-xs text-[#031333]/65 leading-relaxed font-semibold mt-3.5 border-t border-[#a8c940]/5 pt-3">
                    {member.desc}
                  </p>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {insights.map((item, idx) => (
              <div 
                key={idx}
                className="bg-white border border-[#a8c940]/10 rounded-2xl p-6 flex flex-col justify-between h-48 hover:border-[#a8c940]/30 transition group cursor-pointer"
              >
                <div>
                  <span className="text-[8px] font-bold text-[#a8c940] uppercase tracking-widest block mb-3.5 font-mono">
                    {item.category}
                  </span>
                  <h4 className="font-serif font-bold text-sm text-[#031333] leading-snug group-hover:text-[#a8c940] transition">
                    {item.title}
                  </h4>
                </div>
                <div className="flex justify-between items-center pt-4 border-t border-[#a8c940]/5">
                  <span className="text-[9px] text-neutral-400 font-bold font-mono">{item.readTime}</span>
                  <div className="text-[#a8c940] group-hover:translate-x-0.5 transition">
      ...
      {/* PRICING SECTION */}
      <section id="pricing" className="py-20 px-6 lg:px-12 bg-white border-b border-[#a8c940]/10">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 mb-16">
            ...
            <div className="bg-[#F8FAFC] border border-[#a8c940]/15 rounded-full px-4 py-1.5 text-[10px] font-bold text-[#031333] ">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch mb-8">
            ...
            {/* Free Plan */}
            <div className="bg-[#F8FAFC]/40 border border-[#a8c940]/10 rounded-3xl p-8 flex flex-col justify-between hover-card-premium no-hover-translate">
              <div>
                <span className="font-bold text-lg text-[#031333]">Free Plan</span>
                ...
                <div className="my-8">
                  ...
                  <span className="text-[10px] text-[#031333]/50 font-bold uppercase tracking-wider ml-1">FEES</span>
                </div>

                <p className="text-xs text-[#031333]/70 leading-relaxed font-semibold mb-6">Ideal for low-risk investors just getting started.</p>
                
                <ul className="space-y-3.5 border-t border-[#a8c940]/5 pt-6 text-xs text-[#031333]/80 font-medium mb-8">
                  <li className="flex gap-2.5 items-start">
                    <Check className="w-4 h-4 text-[#a8c940] mt-0.5 shrink-0" />
              ...
              <button
                ...
                className="w-full bg-[#031333] text-[#F8FAFC] text-xs font-bold py-3 rounded-lg hover:bg-black transition cursor-pointer"
              >
                Start free
              </button>
            </div>
            ...
            <div className="bg-[#001a00] text-white border border-emerald-950/20 rounded-3xl p-8 flex flex-col justify-between relative hover-card-premium no-hover-translate">
              <div className="absolute top-4 right-4 bg-emerald-900/35 border border-emerald-800/40 text-[#a8c940] text-[8px] font-bold px-2 py-0.5 rounded-full tracking-wider">
                MOST POPULAR
              </div>
              ...
              <div>
                ...
                <div className="my-8">
                  ...
                  <span className="text-[9px] text-[#a8c940] font-bold uppercase tracking-wider ml-1.5 leading-none">of AUA &bull; annual upfront, quarterly true-up</span>
                </div>
                ...
                <ul className="space-y-3.5 border-t border-[#a8c940]/10 pt-6 text-xs text-white/85 font-medium mb-8">
                  <li className="flex gap-2.5 items-start">
                    <Check className="w-4 h-4 text-[#a8c940] mt-0.5 shrink-0" />
              ...
              <button
                ...
                className="w-full bg-white text-[#031333] text-xs font-bold py-3 rounded-lg hover:bg-[#F8FAFC] transition cursor-pointer"
              >
                Talk to advisor
              </button>
            </div>
            ...
            <div className="bg-[#F8FAFC]/40 border border-[#a8c940]/10 rounded-3xl p-8 flex flex-col justify-between hover-card-premium no-hover-translate">
              <div>
                <span className="font-bold text-lg text-[#031333]">Profit-Share Plan</span>
                ...
                <div className="my-8">
                  ...
                  <span className="text-[10px] text-[#031333]/50 font-bold uppercase tracking-wider ml-1">of net gains*</span>
                </div>

                <p className="text-xs text-[#031333]/70 leading-relaxed font-semibold mb-6">Ideal for high-risk investors investing upwards of ₹1 Cr.</p>
          ...
          <p className="text-[10px] text-[#031333]/40 font-semibold max-w-2xl leading-normal">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-4 items-start font-semibold">
            ...
            <div className="space-y-4">
              {/* FAQ 0 */}
              <div className="bg-white border border-[#a8c940]/10 rounded-2xl overflow-hidden transition-all duration-300">
                <button
                  onClick={() => toggleFaq("q0")}
                  className="w-full px-6 py-4.5 text-left flex justify-between items-center gap-4 text-xs font-bold text-[#031333] hover:text-[#a8c940] focus:outline-none cursor-pointer"
                >
                  <span>Are you SEBI registered?</span>
                  <span className="text-base font-mono leading-none">{faqState.q0 ? "−" : "+"}</span>
                </button>
                {faqState.q0 && (
                  <div className="px-6 pb-6 text-xs text-[#031333]/70 leading-relaxed font-semibold border-t border-[#a8c940]/5 pt-4 animate-in fade-in slide-in-from-top-1">
      ...
      <section className="py-20 px-6 lg:px-12 bg-white border-b border-[#a8c940]/10">
        <div className="max-w-5xl mx-auto">
          <div className="bg-[#001a00] text-white border border-emerald-950/20 rounded-3xl p-8 md:p-12 text-center flex flex-col items-center justify-center relative overflow-hidden">
            <span className="text-[9px] font-bold text-[#a8c940] uppercase tracking-widest block mb-4 font-mono">
            ...
            <div className="flex flex-wrap gap-4 justify-center items-center font-semibold">
              <button
                onClick={() => handleOpenContact("Discovery Call")}
                className="bg-white text-[#031333] text-xs font-bold py-3.5 px-6 rounded-full hover:bg-[#F8FAFC] transition duration-200 cursor-pointer"
              >
                Talk to an advisor ↗
              </button>
              <a
          ...
          <div className="bg-white border border-[#a8c940]/15 rounded-2xl max-w-md w-full p-6 relative animate-in zoom-in-95 duration-200">
            ...
            {formSubmitted ? (
              <div className="py-10 text-center flex flex-col items-center justify-center">
                ...
                <h4 className="text-lg font-serif font-bold text-[#031333] mb-1">Consultation Scheduled</h4>
              ...
              <>
                ...
                <form onSubmit={handleFormSubmit} className="space-y-4 font-semibold font-sans">
                  ...
                  <div>
                    <label className="text-[9px] uppercase tracking-wider text-[#a8c940] block mb-1.5 font-bold">Phone Number</label>
                    <input 
                      type="tel" 
                      required
                  ...
                  <div>
                    <label className="text-[9px] uppercase tracking-wider text-[#a8c940] block mb-1.5 font-bold">Approximate Portfolio Size</label>
                    <select
